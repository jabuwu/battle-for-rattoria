...
fn loading_check_progress(
    ...
    let sound_effects = [
        ...
        &asset_library.sounds.unit_peasant_attack,
        &asset_library.sounds.unit_peasant_damage,
        &asset_library.sounds.unit_peasant_die,
        &asset_library.sounds.unit_archer_attack,
        &asset_library.sounds.unit_archer_damage,
        &asset_library.sounds.unit_archer_die,
        &asset_library.sounds.unit_warrior_attack,
        &asset_library.sounds.unit_warrior_damage,
        &asset_library.sounds.unit_warrior_die,
        &asset_library.sounds.unit_mage_attack,
        &asset_library.sounds.unit_mage_damage,
        &asset_library.sounds.unit_mage_die,
        &asset_library.sounds.unit_brute_attack,
        &asset_library.sounds.unit_brute_damage,
        &asset_library.sounds.unit_brute_die,
